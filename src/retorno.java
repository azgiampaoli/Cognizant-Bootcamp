...
public class retorno {
	...
	public static void main(String[] args) {
		...
		System.out.println("A area do quadrado é: " + retorno.area(2));
		System.out.println("A area do retangulo é: " + retorno.area(3, 4));
		System.out.println("A area do trapézio é: " + retorno.area(1, 2, 3));
